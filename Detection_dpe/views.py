...
from .models import ImagesUpload, Detections
from .serializers import ImageUploadSerializer
from .detection_models.yolov8 import YOLOv8Detector 

class UploadImageView(APIView):
    detector = YOLOv8Detector("C:/Users/BRAHIAN SANCHEZ/Documents/data_Django/image_acquisition/models/dpe.pt")
    ...
    def post(self, request, format=None):
        ...
        if serializer.is_valid():
            ...
            try:
                ...
                image_upload.status = ImagesUpload.STATUS_COMPLETED
                image_upload.save()
                
            except Exception as e:
                image_upload.status = ImagesUpload.STATUS_FAILED
                image_upload.save()
